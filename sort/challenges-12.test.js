...
const sortBackwards = (nums) => nums.sort( (a, b) => a < b);
...
const alphabetize = (strings) => strings.sort( (a, b) => a > b);
...
const sortMeetingsByDay = (meetings) => meetings.sort( (a, b) => days.indexOf(a.dayOfWeek) > days.indexOf(b.dayOfWeek));
